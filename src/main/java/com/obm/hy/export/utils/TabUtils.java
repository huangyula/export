...
public class TabUtils {
    public static void setTab(Context context, PagerSlidingTabStrip indicator, DisplayMetrics dm){
        ...
        // 设置Tab Indicator的颜色
        indicator.setIndicatorColor(ContextCompat.getColor(context, R.color.light_blue));
        // 设置选中Tab文字的颜色 (这是我自定义的一个方法)
        indicator.setSelectedTextColor(ContextCompat.getColor(context,R.color.light_blue));
        // 取消点击Tab时的背景色
